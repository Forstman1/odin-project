...
const authHOC = (WrappedComponent: any) => {
  ...
  const AuthenticatedComponent = (props: any) => {
    ...
    const { isLoading, isError, data } = useQuery(['checkTokenValidity', token], () => checkTokenValidity(token));

    if (isLoading) {
      return <div className="text-center h-screen w-full flex justify-center items-center">
      <div role="status">
